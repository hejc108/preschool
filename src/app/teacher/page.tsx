...
export default function TeacherPwaPage() {
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-sky-50 via-slate-50 to-sky-100/50 text-slate-800 flex flex-col justify-center items-center p-4 relative overflow-hidden font-sans">
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-sky-200/50 rounded-full blur-3xl pointer-events-none" />
        
        <div className="max-w-md w-full bg-white/95 backdrop-blur-md border border-sky-100 rounded-3xl p-6 sm:p-8 shadow-2xl relative z-10 text-slate-800 text-center ring-1 ring-sky-900/5">
          <div className="w-16 h-16 bg-gradient-to-tr from-sky-500 to-sky-600 rounded-2xl mx-auto mb-4 flex items-center justify-center text-white shadow-lg shadow-sky-500/30">
            <Sparkles className="w-8 h-8" />
          </div>
          
          <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">Cổng Tác Nghiệp Giáo Viên</h1>
          <p className="text-sky-700 font-semibold text-xs mt-1 mb-6">Trường Mầm Non Sương Mai</p>
          ...
          <p className="text-xs text-slate-400 leading-relaxed">Dành cho Giáo viên & BGH trường Mầm Non Sương Mai.</p>
        </div>
      </div>
    );
  }
