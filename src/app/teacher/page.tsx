    ...
    return (
      <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col justify-center items-center p-4 relative overflow-hidden">
        ...
        <div className="max-w-md w-full bg-white border border-slate-200/80 rounded-convent p-6 sm:p-8 shadow-xl relative z-10 text-slate-800 text-center">
          ...
          <h1 className="text-2xl font-bold text-sky-700 tracking-tight">Cổng Tác Nghiệp Giáo Viên</h1>
          ...
          <p className="text-xs text-slate-400">Dành cho Giáo viên và Ban giám hiệu trường Mầm Non Sương Mai.</p>
        </div>
      </div>
    );
  }
